...
PyMODINIT_FUNC PyInit_inventor(void)
{
	static PyMethodDef iv_methods[] = 
	{
		...
		{ "image", (PyCFunction) iv_image, METH_VARARGS | METH_KEYWORDS,
            "Renders a scene into an offscreen buffer using the inventor SoOffscreenRenderer\n"
			"class. Note that this class creates a private, none-shared OpenGL context. If\n"
			"you are using a GUI framework such as Qt then it is better to do the offscreen\n"
			"rendering with QtOpenGL.QGLFramebufferObject because the application controls\n"
